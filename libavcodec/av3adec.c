    ...
    *got_frame_ptr = 0;
    ...
    if (avpkt->size>0)
    {
        ...
        while (size > 0)//
        {
            ...
            frm->channel_layout = av_get_default_channel_layout(avctx->channels);
            ChannelNumConfig chconf = s->handle->channelNumConfig;
            if(frm->channels == 1)
                frm->ch_layout = (AVChannelLayout)AV_CHANNEL_LAYOUT_MONO;// need set frm->ch_payout to frame ch_out verification
            else if(frm->channels == 2)
                frm->ch_layout = (AVChannelLayout)AV_CHANNEL_LAYOUT_STEREO;// need set frm->ch_payout to frame ch_out verification
            else if(chconf == CHANNEL_CONFIG_MC_5_1_4 && frm->channels == 10)
                frm->ch_layout = (AVChannelLayout)AV_CHANNEL_LAYOUT_5POINT1POINT4_BACK;
            else if(chconf == CHANNEL_CONFIG_MC_7_1_2 && frm->channels == 10)
                frm->ch_layout = (AVChannelLayout)AV_CHANNEL_LAYOUT_7POINT1POINT2;
            else if(chconf == CHANNEL_CONFIG_MC_7_1_4 && frm->channels == 12)
                frm->ch_layout = (AVChannelLayout)AV_CHANNEL_LAYOUT_7POINT1POINT4_BACK;
            else if(chconf == CHANNEL_CONFIG_HOA_ORDER3 && frm->channels == 16)
            ...
            avctx->ch_layout.nb_channels = frm->channels;
